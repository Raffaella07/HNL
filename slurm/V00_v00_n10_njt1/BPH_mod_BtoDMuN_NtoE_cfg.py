...
process.MuElectronFilter = cms.EDFilter("MCParticlePairFilter",
    ...
    MinPt = cms.untracked.vdouble(5., -1),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            #particle_property_file = cms.FileInPath('$PWD/evtGenData/evt_2014_mass{m}_ctau{ctau}.pdl'.format(m=options.mass,ctau=options.ctau)), 
            particle_property_file = cms.FileInPath('evt_2014_mass1.0_ctau107.535167851.pdl'), 
